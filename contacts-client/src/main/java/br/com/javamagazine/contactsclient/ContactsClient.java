...
public class ContactsClient {
	...
	public Contact add(Contact contact) {
		...
		Response response = invocationBuilder.post(Entity.entity(contact,
	...
	public void update(Contact contact) {
		...
		Response response = invocationBuilder.put(Entity.entity(contact,
				MediaType.APPLICATION_JSON));
	...
	public void delete(Contact contact) {
		WebTarget deleteTarget = baseTarget.queryParam("contactId",
				contact.getId());
